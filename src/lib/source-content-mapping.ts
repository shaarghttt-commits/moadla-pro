...
const SOURCE_SECTIONS = [
  {
    ...
    slug: 'engineering',
    description:
      'موقع المعادلة سايت يشارك كل ما يتعلق بمعادلات الدبلومات الفنية، ويستهدف طلاب الدبلومات والمعاهد في مسار الهندسة مع مواد مساندة وتحديثات أكاديمية.',
    icon: 'Cpu',
    color: 'blue',
    order: 1,
  },
...
const SOURCE_PAGES = [
  {
    slug: 'about-source',
    title: 'من نحن؟',
    description: 'موقع المعادلة سايت هو موقع إلكتروني يهدف إلى مشاركة كل ما يتعلق بمعادلات الدبلومات الفنية.',
    contentMarkdown: `موقع المعادلة سايت هو موقع إلكتروني يهدف إلى مشاركة كل ما يتعلق بمعادلات الدبلومات الفنية.
...
الهدف الرئيسي هو تبسيط المعلومات الأكاديمية وتوفير مصادر تعليمية منظمة ومفيدة في المسارات المعتمدة.`,
    seoTitle: 'من نحن | المعادلة سايت',
    seoDescription: 'موقع المعادلة سايت يهدف إلى مشاركة كل ما يتعلق بمعادلات الدبلومات الفنية والمناهج الأكاديمية.',
...
للاستفسارات والدعم: 01070130096`,
    seoTitle: 'تواصل معنا | المعادلة سايت',
    seoDescription: 'تواصل مع منصة المعادلة سايت عبر الصفحات الرسمية والدعم المتاح.',
  ...
  },
  {
    ...
    contentMarkdown: `ساعدنا على الاستمرار! الموقع يقدم الدعم للطلاب ونشر المحتوى التعليمي المساند في مسارات المعادلات.

يمكن دعم الموقع من خلال رابط التبرع الرسمي ومتابعة الروابط الرسمية المتاحة في الموقع.` ,
    seoTitle: 'دعم الموقع | المعادلة سايت',
    seoDescription: 'معلومات دعم الموقع والجهود المستمرة في نشر محتوى المعادلات.',
